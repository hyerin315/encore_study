	...
	<div class="container">
		...
		<form class="form-horizontal" method="post" action="./calc2">
			<div class="form-group">
				...
				<label class="control-label col-sm-5" style="color:red" for="menu">${menu}</label>
			</div>
			<div class="form-group">
				...
				<label class="control-label col-sm-5" style="color:red" for="price">${price}</label>
			</div>
			<div class="form-group">
				...
				<label class="control-label col-sm-5"  style="color:red" for="count">${count}</label>
			</div>
			<div class="form-group">
