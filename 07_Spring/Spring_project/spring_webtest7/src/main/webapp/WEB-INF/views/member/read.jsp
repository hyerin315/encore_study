...
<h2 class="col-sm-offset-2 col-sm-10">${dto.mname}의 회원정보</h2>
		<table class="table table-bordered">
			<tr>
				<td colspan="2" style="text-align: center"><img
					src="${root}/storage/${dto.fname}" width="250px" height="250px"
		...
		<div style="text-align: center">
			...
			<c:if test="${not empty dto.id and dto.grade != 'A'}">
				...
				<!-- 멤버에서의 다운로드 : ./download -->
				<button class="btn btn-default" onclick="location.href='./download?dir=storage&filename=${dto.fname}'">다운로드</button>
			</c:if>
