...
<!--         <button type='button'  -->
<%--                     onclick="location.href='./list_by_cateno_search?cateno=${param.cateno}'" --%>
<!--                     class="btn btn-info">유형 2: 목록 + 검색(list_by_cateno_search)</button><br>                     -->
<!--         <button type='button'  -->
<%--                     onclick="location.href='./list_by_cateno_search_paging?cateno=${param.cateno}'" --%>
<!--                     class="btn btn-info">유형 3: 목록 + 검색 + 페이징(list_by_cateno_search_paging)</button><br>        -->
        <button type='button' 
