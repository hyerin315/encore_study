...
VALUES(cate_seq.nextval, 2, '가을', 1, 'Y', sysdate, 0);
INSERT INTO cate(cateno, categrpno, name, seqno, visible, rdate, cnt)
VALUES(cate_seq.nextval, 2, '겨울', 1, 'Y', sysdate, 0);
INSERT INTO cate(cateno, categrpno, name, seqno, visible, rdate, cnt)
VALUES(cate_seq.nextval, 2, '봄', 1, 'Y', sysdate, 0);
COMMIT;
-- 목록
...
-- 수정
UPDATE cate
SET categrpno=2, name='식당', seqno = 10, visible='N', cnt=0
WHERE cateno = 3;
commit;
-- 삭제
DELETE cate
